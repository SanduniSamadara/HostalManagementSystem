...
//        setUI("RegistrationForm");
        Parent parent = FXMLLoader.
                load(getClass().getResource("lk/ijse/hibernate/view/RegistrationForm.fxml"));
...
//        setUI("StudentForm");
        Parent parent = FXMLLoader.
                load(getClass().getResource("lk/ijse/hibernate/view/StudentManagementForm.fxml"));
        dashBoardFormContext.getChildren().clear();
        dashBoardFormContext.getChildren().add(parent);
    }
...
//        setUI("RoomForm");
        Parent parent = FXMLLoader.
                load(getClass().getResource("lk/ijse/hibernate/view/RoomManagementForm.fxml"));
        dashBoardFormContext.getChildren().clear();
        dashBoardFormContext.getChildren().add(parent);
    }
...
//        setUI("UserForm");
        Parent parent = FXMLLoader.
                load(getClass().getResource("lk/ijse/hibernate/view/UserForm.fxml"));
        dashBoardFormContext.getChildren().clear();
        dashBoardFormContext.getChildren().add(parent);
...
//        setUI("PendingKeyMoneyForm");
        Parent parent = FXMLLoader.
                load(getClass().getResource("lk/ijse/hibernate/controller/PendingKeyMoneyFormController.java"));
        dashBoardFormContext.getChildren().clear();
        dashBoardFormContext.getChildren().add(parent);
    }
